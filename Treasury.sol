...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x9A896d3c54D7e45B558BD5fFf26bF1E8C031F93b), // MainGenesisPool
        address(0xa7b9123f4b15fE0fF01F469ff5Eab2b41296dC0E) // new MainRewardPool
    ];
    ...
    function _sendToMasonry(uint256 _amount) internal {
        ...
        IERC20(main).safeApprove(masonry, 0);
        IERC20(main).safeApprove(masonry, _amount);
    ...
    function allocateSeigniorage() external onlyOneBlock checkCondition checkEpoch checkOperator {
        ...
        if (epoch < bootstrapEpochs) {
            ...
            _sendToMasonry(mainSupply.mul(bootstrapSupplyExpansionPercent).div(10000));
        } else {
            if (previousEpochMainPrice > mainPriceCeiling) {
                // Expansion ($MAIN Price > 1 $FTM): there is some seigniorage to be allocated
                ...
                if (seigniorageSaved >= bondSupply.mul(bondDepletionFloorPercent).div(10000)) {
                    ...
                    _savedForMasonry = mainSupply.mul(_percentage).div(1e18);
                } else {
